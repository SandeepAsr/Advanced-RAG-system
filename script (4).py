...
ingestion_content = '''"""Document ingestion and processing module"""
...
with open(base_dir / "src" / "ingestion" / "document_processor.py", "w") as f:
    f.write(ingestion_content)
    
print("Document ingestion module created!")